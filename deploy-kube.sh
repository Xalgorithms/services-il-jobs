...
# effective
DEPS="https://dl.bintray.com/spark-packages/maven/datastax/spark-cassandra-connector/2.3.1-s_2.11/spark-cassandra-connector-2.3.1-s_2.11.jar,http://central.maven.org/maven2/com/typesafe/config/1.3.1/config-1.3.1.jar,http://central.maven.org/maven2/org/apache/spark/spark-streaming-kafka-0-10_2.11/2.3.0/spark-streaming-kafka-0-10_2.11-2.3.0.jar,http://central.maven.org/maven2/net/ceedubs/ficus_2.11/1.1.1/ficus_2.11-1.1.1.jar,http://central.maven.org/maven2/org/mongodb/spark/mongo-spark-connector_2.11/2.2.0/mongo-spark-connector_2.11-2.2.0.jar,http://central.maven.org/maven2/org/gnieh/diffson-play-json_2.11/2.2.1/diffson-play-json_2.11-2.2.1.jar,http://central.maven.org/maven2/org/apache/kafka/kafka-clients/2.0.0/kafka-clients-2.0.0.jar,http://central.maven.org/maven2/com/typesafe/play/play-json_2.11/2.6.10/play-json_2.11-2.6.10.jar,http://central.maven.org/maven2/com/typesafe/play/play-functional_2.11/2.6.10/play-functional_2.11-2.6.10.jar"
